...
seg_upd3c = UpdatedParametersForFixedCP(OneSeries = df3c, 
...
\footnotesize
```{r update1, echo = TRUE, message=FALSE, fig.width = 6, fig.height = 3}
seg_upd3d = UpdatedParametersForFixedCP(OneSeries = df3d, 
                                      ResScreening = screening2)
str(seg_upd3d)
seg_upd3d$Tmu
```
...
\footnotesize
```{r plotupdate1, echo = TRUE, message=FALSE, fig.width = 6, fig.height = 1.5}
PlotSeg(OneSeries = df3d, 
        SegRes = seg_upd3d,
        RemoveData = screening2$RemoveData)
```
Compare to the result before the cluster screening
```{r plotcompare1, echo = TRUE, message=FALSE, fig.width = 6, fig.height = 1.5}
PlotSeg(OneSeries = df3d, 
        SegRes = seg3d)
```
...
\footnotesize
```{r plotupdate2, echo = TRUE, message=FALSE, fig.width = 6, fig.height = 1.5}
PlotSeg(OneSeries = df3c, 
        SegRes = seg_upd3c,
        RemoveData = screening1$RemoveData)
```
Compare to the result before the cluster screening
```{r plotcompare2, echo = TRUE, message=FALSE, fig.width = 6, fig.height = 1.5}
PlotSeg(OneSeries = df3c, 
        SegRes = seg3c)
```
