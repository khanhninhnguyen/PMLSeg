...
noise_stdev <- c(0.1, 0.3, 0.7, 1.2, 1.8, 2, 2, 1.8, 1.2, 0.7, 0.3, 0.1)

# create a time series df
set.seed(1)
mydate <- seq.Date(from = as.Date("2010-01-01"), to = as.Date("2010-01-01")+(length_series-1), by = "day")
mysignal <- simulate_time_series(cp_ind, segmt_mean, noise_stdev, length_series)
...
# as well as the segmentation results
