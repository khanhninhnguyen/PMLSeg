...
The periodic signal is now captured by the functional part but the segmentation fails to capture the CPs.
...
The periodic signal is captured by the functional part and the segmentation now captures the CPs.
