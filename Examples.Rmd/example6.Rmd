...
The selection helps to reduce the confusion  between periodic signal and segmentation.
...
The ```UpdatedParametersForFixedCP``` has an option to statistically significant Fourier coefficients:
