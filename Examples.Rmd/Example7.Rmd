...
Based on a large set of simulations, we checked that all four criteria find the correct number of CPs with the recommended (default) strategy `selectionF = FALSE` and `initf = "both"`.
