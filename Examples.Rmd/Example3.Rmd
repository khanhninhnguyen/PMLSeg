...
So it is necessary to update also `df`: replace the data removed by the screening with NA values in `df$signal`. This step is mandatory before running again the Validation or using PlotSeg.
