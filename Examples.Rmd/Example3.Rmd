...
So it is necessary to update also `df`. Two options are possible: either replace the data removed by the screening with NA values in `df$signal` or simply remove the data from `df`. This step is mandoroty before running again the Validation.
