...
The `Tmu` dataframe contains, for each segment: the index of beginning and end, the estimated mean and its standard erreor, and the number of valid data points (non-NA values in the signal):
