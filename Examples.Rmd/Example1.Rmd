...
`Tmu` is a list which contains, for each segment: the index of beginning and end, the estimated mean and its standard erreor, and the number of valid data points (non-NA values in the signal):
...
For the example, we create a fake metadata data frame with the true dates of CPs and invented types of change
