...
Note: the data in the clusters are hidden by the Plot function with the RemoveData option, but they are still in the time series dataframe. To actually remove the data do the following:
